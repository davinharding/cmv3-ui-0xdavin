...
export const mintText = [
  ...
  { label: "cbarP", mintText: "Cbar Mint: 0.15 SOL", buttonLabel: "Mint now!", header: "CBAR SOL Mint" },
  { label: "wlGF", mintText: "Guaranteed Free Mint for WL", buttonLabel: "Mint now!", header: "WL Guaranteed Free"}, // DAVIN: modify and match to current al in allowlist.tsx
  { label: "wlGP", mintText: "WL Mint: 0.2 SOL", buttonLabel: "Mint now!", header: "WL Guaranteed SOL"},
